  ...
  return (
    <div className="flex">
      <div className="bg-[#FFFFFF] p-3 flex flex-col ml-[13px] gap-9 mt-[15px]">
        <button className="flex gap-4 text-headerBlack text-base hover:bg-gray-300 text-nowrap">
          <LayoutGrid size={24} strokeWidth={3} absoluteStrokeWidth />
          Хяналтын самбар
        </button>
        <button className="flex gap-4 text-headerBlack text-base hover:bg-gray-300">
